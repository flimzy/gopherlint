...
import (
	...
	"github.com/flimzy/gopherlint/pkg/golinters"
	"github.com/flimzy/gopherlint/pkg/golinters/arangolint"
	"github.com/flimzy/gopherlint/pkg/golinters/asasalint"
	"github.com/flimzy/gopherlint/pkg/golinters/asciicheck"
	"github.com/flimzy/gopherlint/pkg/golinters/bidichk"
	"github.com/flimzy/gopherlint/pkg/golinters/bodyclose"
	"github.com/flimzy/gopherlint/pkg/golinters/canonicalheader"
	"github.com/flimzy/gopherlint/pkg/golinters/clickhouselint"
	"github.com/flimzy/gopherlint/pkg/golinters/containedctx"
	"github.com/flimzy/gopherlint/pkg/golinters/contextcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/copyloopvar"
	"github.com/flimzy/gopherlint/pkg/golinters/cyclop"
	"github.com/flimzy/gopherlint/pkg/golinters/decorder"
	"github.com/flimzy/gopherlint/pkg/golinters/depguard"
	"github.com/flimzy/gopherlint/pkg/golinters/dogsled"
	"github.com/flimzy/gopherlint/pkg/golinters/dupl"
	"github.com/flimzy/gopherlint/pkg/golinters/dupword"
	"github.com/flimzy/gopherlint/pkg/golinters/durationcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/embeddedstructfieldcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/err113"
	"github.com/flimzy/gopherlint/pkg/golinters/errcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/errchkjson"
	"github.com/flimzy/gopherlint/pkg/golinters/errname"
	"github.com/flimzy/gopherlint/pkg/golinters/errorlint"
	"github.com/flimzy/gopherlint/pkg/golinters/exhaustive"
	"github.com/flimzy/gopherlint/pkg/golinters/exhaustruct"
	"github.com/flimzy/gopherlint/pkg/golinters/exptostd"
	"github.com/flimzy/gopherlint/pkg/golinters/fatcontext"
	"github.com/flimzy/gopherlint/pkg/golinters/forbidigo"
	"github.com/flimzy/gopherlint/pkg/golinters/forcetypeassert"
	"github.com/flimzy/gopherlint/pkg/golinters/funcorder"
	"github.com/flimzy/gopherlint/pkg/golinters/funlen"
	"github.com/flimzy/gopherlint/pkg/golinters/gci"
	"github.com/flimzy/gopherlint/pkg/golinters/ginkgolinter"
	"github.com/flimzy/gopherlint/pkg/golinters/gocheckcompilerdirectives"
	"github.com/flimzy/gopherlint/pkg/golinters/gochecknoglobals"
	"github.com/flimzy/gopherlint/pkg/golinters/gochecknoinits"
	"github.com/flimzy/gopherlint/pkg/golinters/gochecksumtype"
	"github.com/flimzy/gopherlint/pkg/golinters/gocognit"
	"github.com/flimzy/gopherlint/pkg/golinters/goconst"
	"github.com/flimzy/gopherlint/pkg/golinters/gocritic"
	"github.com/flimzy/gopherlint/pkg/golinters/gocyclo"
	"github.com/flimzy/gopherlint/pkg/golinters/godoclint"
	"github.com/flimzy/gopherlint/pkg/golinters/godot"
	"github.com/flimzy/gopherlint/pkg/golinters/godox"
	"github.com/flimzy/gopherlint/pkg/golinters/gofmt"
	"github.com/flimzy/gopherlint/pkg/golinters/gofumpt"
	"github.com/flimzy/gopherlint/pkg/golinters/goheader"
	"github.com/flimzy/gopherlint/pkg/golinters/goimports"
	"github.com/flimzy/gopherlint/pkg/golinters/golines"
	"github.com/flimzy/gopherlint/pkg/golinters/gomoddirectives"
	"github.com/flimzy/gopherlint/pkg/golinters/gomodguard"
	"github.com/flimzy/gopherlint/pkg/golinters/goprintffuncname"
	"github.com/flimzy/gopherlint/pkg/golinters/gosec"
	"github.com/flimzy/gopherlint/pkg/golinters/gosmopolitan"
	"github.com/flimzy/gopherlint/pkg/golinters/govet"
	"github.com/flimzy/gopherlint/pkg/golinters/grouper"
	"github.com/flimzy/gopherlint/pkg/golinters/iface"
	"github.com/flimzy/gopherlint/pkg/golinters/importas"
	"github.com/flimzy/gopherlint/pkg/golinters/inamedparam"
	"github.com/flimzy/gopherlint/pkg/golinters/ineffassign"
	"github.com/flimzy/gopherlint/pkg/golinters/interfacebloat"
	"github.com/flimzy/gopherlint/pkg/golinters/intrange"
	"github.com/flimzy/gopherlint/pkg/golinters/iotamixing"
	"github.com/flimzy/gopherlint/pkg/golinters/ireturn"
	"github.com/flimzy/gopherlint/pkg/golinters/lll"
	"github.com/flimzy/gopherlint/pkg/golinters/loggercheck"
	"github.com/flimzy/gopherlint/pkg/golinters/maintidx"
	"github.com/flimzy/gopherlint/pkg/golinters/makezero"
	"github.com/flimzy/gopherlint/pkg/golinters/mirror"
	"github.com/flimzy/gopherlint/pkg/golinters/misspell"
	"github.com/flimzy/gopherlint/pkg/golinters/mnd"
	"github.com/flimzy/gopherlint/pkg/golinters/modernize"
	"github.com/flimzy/gopherlint/pkg/golinters/musttag"
	"github.com/flimzy/gopherlint/pkg/golinters/nakedret"
	"github.com/flimzy/gopherlint/pkg/golinters/nestif"
	"github.com/flimzy/gopherlint/pkg/golinters/nilerr"
	"github.com/flimzy/gopherlint/pkg/golinters/nilnesserr"
	"github.com/flimzy/gopherlint/pkg/golinters/nilnil"
	"github.com/flimzy/gopherlint/pkg/golinters/nlreturn"
	"github.com/flimzy/gopherlint/pkg/golinters/noctx"
	"github.com/flimzy/gopherlint/pkg/golinters/noinlineerr"
	"github.com/flimzy/gopherlint/pkg/golinters/nolintlint"
	"github.com/flimzy/gopherlint/pkg/golinters/nonamedreturns"
	"github.com/flimzy/gopherlint/pkg/golinters/nosprintfhostport"
	"github.com/flimzy/gopherlint/pkg/golinters/paralleltest"
	"github.com/flimzy/gopherlint/pkg/golinters/perfsprint"
	"github.com/flimzy/gopherlint/pkg/golinters/prealloc"
	"github.com/flimzy/gopherlint/pkg/golinters/predeclared"
	"github.com/flimzy/gopherlint/pkg/golinters/promlinter"
	"github.com/flimzy/gopherlint/pkg/golinters/protogetter"
	"github.com/flimzy/gopherlint/pkg/golinters/reassign"
	"github.com/flimzy/gopherlint/pkg/golinters/recvcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/revive"
	"github.com/flimzy/gopherlint/pkg/golinters/rowserrcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/sloglint"
	"github.com/flimzy/gopherlint/pkg/golinters/spancheck"
	"github.com/flimzy/gopherlint/pkg/golinters/sqlclosecheck"
	"github.com/flimzy/gopherlint/pkg/golinters/staticcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/swaggo"
	"github.com/flimzy/gopherlint/pkg/golinters/tagalign"
	"github.com/flimzy/gopherlint/pkg/golinters/tagliatelle"
	"github.com/flimzy/gopherlint/pkg/golinters/testableexamples"
	"github.com/flimzy/gopherlint/pkg/golinters/testifylint"
	"github.com/flimzy/gopherlint/pkg/golinters/testpackage"
	"github.com/flimzy/gopherlint/pkg/golinters/thelper"
	"github.com/flimzy/gopherlint/pkg/golinters/tparallel"
	"github.com/flimzy/gopherlint/pkg/golinters/unconvert"
	"github.com/flimzy/gopherlint/pkg/golinters/unparam"
	"github.com/flimzy/gopherlint/pkg/golinters/unqueryvet"
	"github.com/flimzy/gopherlint/pkg/golinters/unused"
	"github.com/flimzy/gopherlint/pkg/golinters/usestdlibvars"
	"github.com/flimzy/gopherlint/pkg/golinters/usetesting"
	"github.com/flimzy/gopherlint/pkg/golinters/varnamelen"
	"github.com/flimzy/gopherlint/pkg/golinters/wastedassign"
	"github.com/flimzy/gopherlint/pkg/golinters/whitespace"
	"github.com/flimzy/gopherlint/pkg/golinters/wrapcheck"
	"github.com/flimzy/gopherlint/pkg/golinters/wsl"
	"github.com/flimzy/gopherlint/pkg/golinters/zerologlint"
